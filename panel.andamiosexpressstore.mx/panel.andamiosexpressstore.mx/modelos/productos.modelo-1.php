...
class ModeloProductos{
	...
	/**ACTUALIZAR VENTA DE PRODUCTO DE MANERA MANUAL */
	...
	static public function mdlIngresarProducto($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(id_categoria,tipo,ruta, estado, titulo, titular, descripcion, multimedia, detalles, precio, inventario, portada, oferta, precioOferta, descuentoOferta, imgOferta, finOferta, peso, entrega) VALUES (:id_categoria,:tipo ,:ruta, :estado, :titulo, :titular, :descripcion, :multimedia, :detalles, :precio, :inventario, :portada, :oferta, :precioOferta, :descuentoOferta, :imgOferta, :finOferta,  :peso, :entrega)");
...
/*=============================================
	...
	static public function mdlEditarProducto($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET id_categoria = :id_categoria, tipo = :tipo, ruta = :ruta, estado = :estado, titulo = :titulo, titular = :titular, descripcion = :descripcion, multimedia = :multimedia, detalles = :detalles, precio = :precio, inventario = :inventario ,portada = :portada, oferta = :oferta, precioOferta = :precioOferta, descuentoOferta = :descuentoOferta, imgOferta = :imgOferta, finOferta = :finOferta, entrega = :entrega WHERE id = :id");
