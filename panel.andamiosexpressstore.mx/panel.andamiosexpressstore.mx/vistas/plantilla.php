...
<head>
    ...
    <title>Panel Andamios Express Shop</title>
    ...
    <link rel="stylesheet" href="vistas/dist/css/skins/skin-yellow.min.css">
...
if(isset($_SESSION["validarSesionBackend"]) && $_SESSION["validarSesionBackend"] === "ok"){
 ...
 /**CONTENIDO DEL SITIO */
  ...
  if(isset($_GET["ruta"])){
    ...
    $_GET["ruta"]== "ventas-transferencia" ||
...
======================================-->
    ...
    <script src="vistas/js/gestor-categorias.js"></script>
    <script src="vistas/js/gestor-productos.js"></script>
    <script src="vistas/js/gestor-comercio.js"></script>
    <script src="vistas/js/gestor-ventas.js"></script>
    <script src="vistas/js/gestor-usuarios.js"></script>
    <script src="vistas/js/gestor-administradores.js"></script>
    <script src="vistas/js/gestor-notificaciones.js"></script>
