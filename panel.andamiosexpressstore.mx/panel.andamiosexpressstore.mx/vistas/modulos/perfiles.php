<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li><a href="incio"><i class="fa fa-dashboard"></i> Inicio</a></li>
                       ...
                       echo '<td>'.$value["perfil"].'</td>';
                        ...
                        echo '<td>
                         ...
                         <div class="btn-group">
                           ...
                           <button class="btn btn-warning btnEditarPerfil" idPerfil="'.$value["id"].'" data-toggle="modal" data-target="#modalEditarPerfil"><i class="fas fa-pencil-alt"></i></button>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-header" style="background:#f9dd00; color:black;">
